// src/pages/PropertySearch.jsx - FORCE BUTTONS TO SHOW
      ...
      <div className="container mx-auto px-4 py-6">
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <button onClick={() => fetchProperties(query)} className="text-sm text-blue-600 hover:underline">
              Try again
            </button>
          </div>
        ) : properties.length === 0 ? (
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center gap-4 mb-3 text-gray-600">
                            {beds > 0 && (<div className="flex items-center gap-1"><Bed className="w-4 h-4" /><span className="text-sm font-medium">{beds} bd</span></div>)}
                            {baths > 0 && (<div className="flex items-center gap-1"><Bath className="w-4 h-4" /><span className="text-sm font-medium">{baths} ba</span></div>)}
                            {sqft > 0 && (<div className="flex items-center gap-1"><Square className="w-4 h-4" /><span className="text-sm font-medium">{sqft.toLocaleString()} sqft</span></div>)}
                          </div>
